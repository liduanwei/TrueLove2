...
/*
 * This class is based upon the file ImageViewTouchBase.java which can be found
 * at:
...
public class ZoomableImageView extends ImageView {
    ...
    private void setBaseMatrix(Bitmap bitmap, Matrix matrix) {
        ...
        // ���� ��С���� 0.1
//        float widthScale = Math.min(viewWidth / (float) bitmap.getWidth(), 0.1f);
//        float heightScale = Math.min(viewHeight / (float) bitmap.getHeight(), 0.1f);
