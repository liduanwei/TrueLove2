...
import me.himi.love.IAppServiceExtend.LoadFollowsPostParams;
import me.himi.love.IAppServiceExtend.OnLoadFollowsResponseListener;
import me.himi.love.MyApplication;
import me.himi.love.R;
import me.himi.love.adapter.UserFollowsAdapter;
 ...
 */
public class UserFollowsActivity extends BaseActivity implements OnItemClickListener {

    com.handmark.pulltorefresh.library.PullToRefreshListView mVisitorsListView;

    me.himi.love.adapter.UserFollowsAdapter mUserRecommendAdapter;
	...
	tvTopAction.setText("");
	tvTopTitle.setText(nickname + " 的关注");
	...
	mUserRecommendAdapter = new UserFollowsAdapter(this, new ArrayList<FollowUser>());
	...
	LoadFollowsPostParams params = new LoadFollowsPostParams();
	params.page = pageNumber;
	params.pageSize = 10;
	params.userId = targetUserId;

	// 加载关注
	AppServiceExtendImpl.getInstance().loadUserFollows(params, new OnLoadFollowsResponseListener() {

	    @Override
	    public void onSuccess(List<FollowUser> users) {
		...
		// TODO Auto-generated method stub
		ActivityUtil.show(UserFollowsActivity.this, errorMsg);
	...
	FollowUser user = mUserRecommendAdapter.getList().get(position);
	...
	// 
	if (null == emptyView) {
	    emptyView = LayoutInflater.from(UserFollowsActivity.this).inflate(R.layout.empty_visitors, null);
	}
