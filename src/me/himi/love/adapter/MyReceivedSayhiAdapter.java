...
/**
 * @ClassName:MyReceivedSayhiAdapter
 * @author sparklee liduanwei_911@163.com
 * @date Nov 2, 2014 2:52:14 PM
 */
public class MyReceivedSayhiAdapter extends BaseListAdapter<ReceivedSayHi> {

    public MyReceivedSayhiAdapter(Context context, List<ReceivedSayHi> list) {
	super(context, list);
    }
	...
	if (null == convertView) {
	    convertView = LayoutInflater.from(mContext).inflate(R.layout.received_sayhi_item, null);
	}
	...
	ReceivedSayHi msg = list.get(position);

	ImageLoader.getInstance().displayImage(msg.getFaceUrl(), ivIcon, ImageLoaderOptions.rounderOptions(), new ImageLoadingListener() {
