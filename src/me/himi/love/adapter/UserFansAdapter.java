...
public class UserFansAdapter extends BaseListAdapter<FansUser> {

    public UserFansAdapter(Context context, List<FansUser> list) {
	super(context, list);
    }
	...
	final FansUser user = this.list.get(position);
