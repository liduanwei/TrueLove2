...
public class UserVisitorsAdapter extends BaseListAdapter<VisitorUser> {

    public UserVisitorsAdapter(Context context, List<VisitorUser> list) {
	super(context, list);
    }
	...
	if (null == convertView) {
	    convertView = LayoutInflater.from(mContext).inflate(R.layout.user_visitor_item, null);
	}

	final VisitorUser user = this.list.get(position);
