...
public class AppServiceExtendImpl implements IAppServiceExtend {
	...
	nameAndValues.put("marital_status", postParams.maritalStatus);
     ...
     */
    @Override
    public void loadArticlesByUserId(LoadArticlesByUserIdPostParams postParams, final OnLoadArticlesResponseListener listener) {
	String url = Constants.URL_ARTICLES_BY_USERID;
	...
	AsyncHttpResponseHandler responseHandler = new AsyncHttpResponseHandler() {
		...
		try {
		    ...
		    int articlesCount = jsonObj.getInt("articles_count"); // 帖子数量
		    ...
		    homeInfo.articles = articlesCount;
